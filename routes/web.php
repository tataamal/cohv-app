...
Route::middleware('auth')->group(function (){
    ...
    Route::post('/create-wi/fetch-status', [CreateWiController::class, 'fetchProStatus'])->name('create-wi.fetch-status');
    Route::post('/create-wi/daily-capacity', [CreateWiController::class, 'getDailyCapacity'])->name('create-wi.daily-capacity'); // [NEW]
