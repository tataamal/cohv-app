...
<div class="container-frame">
                ...
                <table class="branding-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="doc-title">PRODUCTION RESULT REPORT</div>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table>
        <tr class="summary-header">
            <td width="25%">Total Assigned Qty</td>
            <td width="25%">Total Confirmed Qty</td>
            <td width="25%">Unconfirmed (Loss/WIP)</td>
            <td width="25%">Achievement Rate</td>
        </tr>
    ...
    <table style="table-layout: fixed;">
        ...
        <tbody>
            ...
            <tr class="data-row">
                ...
                <td class="text-center">{{ \Carbon\Carbon::parse($row['expired_at'])->format('d-m H:i') }}</td>
