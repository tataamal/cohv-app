...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        View::composer('components.navigation.sidebar', function ($view) {
            ...
            if (Request::routeIs(['manufaktur.dashboard.show', 'list.gr', 'wc.details', 'manufaktur.show.detail.data2','manufaktur.pro.transaction.detail','cogi.report', 'search.stock'])) {
