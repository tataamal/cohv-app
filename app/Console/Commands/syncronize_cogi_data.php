...
class syncronize_cogi_data extends Command
{
    protected $signature = 'syncronize:cogi-data';
    protected $description = 'Syncronize cogi data seng akeh kui';

    public function handle(): int
    {
        $apiPath = base_path('cogi.py');
