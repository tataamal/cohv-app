...
class syncronize_cohv_data extends Command
{
    protected $signature = 'syncronize:cohv-data';
    protected $description = 'Syncronize cohv data seng akeh kui';

    public function handle(): int
    {
        $apiPath = base_path('sync_cohv.py');
