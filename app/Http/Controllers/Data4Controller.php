...
class Data4Controller extends Controller
{
    public function addComponent(Request $request)
    {
        ...
        try {
            ...
            $flaskEndpoint = 'http://127.0.0.1:8055/api/add_component';
    ...
    public function deleteBulkComponents(Request $request)
    {
        ...
        try {
            ...
            $flaskEndpoint = 'http://127.0.0.1:8055/api/delete_component'; // Ganti dengan URL Flask Anda
    ...
    private function refreshAndSyncOrderByAufnr(string $aufnr, string $plant): array
    {
        try {
            ...
            $flaskRefreshUrl = 'http://127.0.0.1:8055/api/refresh-pro'; // Sesuaikan URL
    ...
    public function show_stock(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withHeaders([
                'X-SAP-Username' => $username,
                'X-SAP-Password' => $password,
            ])->timeout(120)->get('http://127.0.0.1:8055/api/get_stock', $queryParams); // Panggil endpoint yang benar
